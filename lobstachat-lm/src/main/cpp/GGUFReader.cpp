...
Java_com_roblobsta_lobstachat_lm_GGUFReader_getGGUFContextNativeHandle(JNIEnv* env, jobject thiz, jstring modelPath) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_roblobsta_lobstachat_lm_GGUFReader_getContextSize(JNIEnv* env, jobject thiz, jlong nativeHandle) {
...
Java_com_roblobsta_lobstachat_lm_GGUFReader_getChatTemplate(JNIEnv* env, jobject thiz, jlong nativeHandle) {
    gguf_context* ggufContext       = reinterpret_cast<gguf_context*>(nativeHandle);
